...
export ADVISOR_2019_DIR='/home/ghaase/Lectures/Math2CPP/Codes/par/mgrid'
export PYTHONPATH='/home/ghaase/Lectures/Math2CPP/Codes/par/mgrid/pythonapi'${PYTHONPATH:+:${PYTHONPATH}}
