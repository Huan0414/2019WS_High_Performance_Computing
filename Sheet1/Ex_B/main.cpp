...
int main()
{
    cout <<"This exercise is to read the data from ASCII file data_1.txt into"
         <<"an STL-vector and determine minimum, maximum, mean values and deviation"
         <<"of the data. In the end write those values into an ASCII file out_1.txt"<<endl;
